...
crm_prp <- as.numeric(guerry_sp$Crm_prp)
```
### Local Moran Map
...
```{r}
Crm_prp <- as.numeric(guerry_sp$Crm_prp)
Litercy <- as.numeric(guerry_sp$Litercy)
Donatns <- as.numeric(guerry_sp$Donatns)
Infants <- as.numeric(guerry_sp$Infants)
Suicids <- as.numeric(guerry_sp$Suicids)
